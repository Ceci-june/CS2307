...
CREATE TABLE IF NOT EXISTS properties (
    ...
    pool BOOLEAN, gym BOOLEAN, park BOOLEAN, bbq BOOLEAN,
    kids_playground BOOLEAN, sports_court BOOLEAN, security_24h BOOLEAN,
    reception BOOLEAN, elevator BOOLEAN, parking BOOLEAN,
    near_metro BOOLEAN, near_bus BOOLEAN, near_highway BOOLEAN,
    near_school BOOLEAN, near_hospital BOOLEAN, near_mall BOOLEAN,
    near_market BOOLEAN, near_park BOOLEAN,
    river_view BOOLEAN, park_view BOOLEAN, city_view BOOLEAN,
    balcony BOOLEAN, garden BOOLEAN, garage BOOLEAN, terrace BOOLEAN,
...
ALTER TABLE properties ADD COLUMN IF NOT EXISTS embedding_model VARCHAR(255);
ALTER TABLE properties ADD COLUMN IF NOT EXISTS search_text_version VARCHAR(32);
ALTER TABLE properties ADD COLUMN IF NOT EXISTS former_admin_area VARCHAR(255);
ALTER TABLE properties ADD COLUMN IF NOT EXISTS geo_cluster_150m VARCHAR(255);
ALTER TABLE properties ADD COLUMN IF NOT EXISTS data_quality_flags TEXT;
ALTER TABLE properties ADD COLUMN IF NOT EXISTS coordinate_confidence DOUBLE PRECISION;
...
ON listing_amenity_distances (listing_id, category, driving_distance_km, driving_duration_min);
